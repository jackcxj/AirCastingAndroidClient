...
import pl.llp.aircasting.screens.common.base.NewRoboMapActivityWithProgress;
...
public abstract class NewAirCastingBaseActivity extends NewRoboMapActivityWithProgress implements View.OnClickListener, LocationHelper.LocationSettingsListener{
        ...
        if (shouldCheckForUnfinishedSessions()) {
            new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... voids) {
                    checker.finishIfNeeded(NewAirCastingBaseActivity.this);
